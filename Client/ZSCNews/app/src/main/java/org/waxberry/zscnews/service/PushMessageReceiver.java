package org.waxberry.zscnews.service;
...
/**
 * Created by GJH-08 on 2014/10/4.
 */
public class PushMessageReceiver extends FrontiaPushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            PushServiceUtils.setBind(context, true);
        }
        // ToDo: Demo更新界面展示代码，应用请在这里加入自己的处理逻辑
    }
    ...
    {
        Intent pIntent = new Intent(context, org.waxberry.zscnews.activity.MainActivity.class);
    ...
    public void onUnbind(Context context, int errorCode, String requestId) {
        ...
        // 解绑定成功，设置未绑定flag，
        if (errorCode == 0) {
            PushServiceUtils.setBind(context, false);
        }
        // ToDo: Demo更新界面展示代码，应用请在这里加入自己的处理逻辑
    }
